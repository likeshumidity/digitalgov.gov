jQuery(document).ready(function($) {
  ...
  $('.edit_tools .edit-open').click(function(e){
    ...
    if ( $('.edit_tools').is( ".active" ) ) {
      ...
      $(this).html('<i class="far fa-edit"></i><span class="usa-sr-only">Toggle edit this page</span>');
    } else {
      enable_edit_this();
      $('.edit_tools').addClass('active');
      $(this).html('<i class="fas fa-times"></i><span class="usa-sr-only">Toggle edit this page</span>');
    }
  });
